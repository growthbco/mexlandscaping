  ...
  input_schema: {
    ...
    properties: {
      ...
      proposed_time: {
        type: ["string", "null"],
        description:
          'If the customer proposed or accepted a specific day/time, restate it (e.g. "Thursday morning"). Null otherwise.',
      },
      missing: {
        type: "array",
        items: { type: "string" },
